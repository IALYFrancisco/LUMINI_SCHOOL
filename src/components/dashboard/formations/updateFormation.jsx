...
export default function UpdateFormation(){
    ...
    const [ formation, setFomation ] = useState('')
    const { id } = useParams()
    ...
    useEffect(()=>{
        ...
        .then((response)=>setFomation(response.data))
    },[id])
                            ...
                            formation.map( f => <>
                                <fieldset>
                                    <div className="element">
                                        ...
                                        <input type="text" required name="titre" placeholder="Ajoutez un titre pour la formation" { ...register("title", { required: true, value: f.title })}/>
                                    </div>
                                    <div className="element">
                                    ...
                                    <div className="element">
                                        ...
                                        <input type="text" name="prerequis" id="" placeholder="Doivent être séparés par un point-virgule" { ...register("prerequisites", {required: true, value: f.prerequisites}) } required />
                                    </div>
                                    <div className="element">
                                ...
                                <fieldset>
                                    <div className="element">
                                        ...
                                        <textarea cols="30" rows="10" required name="descriptions" placeholder="Redigez ici les descriptions ..." { ...register("description", { value: f.description, required: "La description est obligatoire.", validate: {
                                            minWords: (value) => 
